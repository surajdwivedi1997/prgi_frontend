...
export const stateDistrictData: StateDistrict[] = [
  {
  ...
  {
    state: "Mizoram",
    districts: ["Aizawl", "Champhai", "Hnahthial", "Khawzawl", "Kolasib", "Lawngtlai", "Lunglei", "Mamit", "Saiha", "Saitul", "Serchhip"]
  },
  {
    state: "Nagaland",
    districts: ["Chumoukedima", "Dimapur", "Kiphire", "Kohima", "Longleng", "Mokokchung", "Mon", "Niuland", "Noklak", "Peren", "Phek", "Tseminyu", "Tuensang", "Wokha", "Zunheboto"]
  },
  {
    state: "Odisha",
...
export const getAllStates = (): string[] => {
  return stateDistrictData.map(item => item.state).sort();
};

export const getDistrictsByState = (state: string): string[] => {
  const stateData = stateDistrictData.find(item => item.state === state);
